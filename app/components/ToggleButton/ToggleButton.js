...
export default class ToggleButton extends React.Component {
    ...
    switch (size) {
      ...
      case 'medium':
        return {
          ...
          circleWidth: moderateScale(22),
          circleHeight: moderateScale(22),
  ...
  static defaultProps = {
    isOn: false,
    onColor: colors.red_light,
    offColor: colors.pinkish_grey,
    size: 'medium',
    labelStyle: {},
    thumbOnStyle: {},
    thumbOffStyle: {},
  ...
  dimensions = ToggleButton.calculateDimensions(this.props.size);
