    ...
    <SafeAreaView style={gs.safeArea}>
      <ScrollView contentContainerStyle={{flexGrow: 1}}>
        <View style={styles.container}>
          <Image source={images.child} style={styles.imageChild} />
          ...
          <View style={styles.txtView}>
            <PoppinsTextMedium
              ...
              Child Tracker & Mother care post Pregnancy
            </PoppinsTextMedium>
          ...
          <View style={styles.skipView}>
            ...
            <TouchableWithoutFeedback onPress={props.navigateToGetStarted}>
...
const styles = StyleSheet.create({
  container: {
    ...
    backgroundColor: colors.walk_child_back,
  },
  ovalShape: {
    width: width,
    height: moderateScale(400),
    backgroundColor: colors.walk_top_back,
    borderBottomLeftRadius: moderateScale(400),
    borderBottomRightRadius: moderateScale(250),
    transform: [{scaleX: 2}],
  },
  imageChild: {
    resizeMode: 'cover',
